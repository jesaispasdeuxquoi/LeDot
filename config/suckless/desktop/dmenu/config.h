...
static const char *fonts[] = {
	"cascadia code:size=11.5:antialias=true:autohint=true",
};

static const char col_soft_black[] = "#111010";
static const char col_gray[] = "#a89c90";
static const char col_dirty_white[] = "#a89c90";
static const char col_red[] = "#d75f5f";
static const char col_dark_yellow[] = "#f7ca88";
static const char col_white[] = "#111010";
static const char col_green[] = "#a89c90";
static const char col_blue[] = "#8197bf";
static const char *prompt = NULL;	/* -p option; prompt to the left of input field */
static const char *colors[SchemeLast][2] = {
	/* fg bg */
	[SchemeNorm] = {col_dirty_white, col_soft_black},	// Normal
	[SchemeSel] = {col_white, col_gray},	// Selected
